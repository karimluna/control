...
ax1.plot(t, signal, lw=1.2, color='blue', label='Signal')
ax1.plot(t, envelope, '--', color='red', lw=0.8, alpha=0.5, label='Envelope')
ax1.plot(t, -envelope, '--', color='red', lw=0.8, alpha=0.5)
ax1.set_title(r'$e^{\sigma t} \sin(\omega t)$', fontsize=10)
ax1.set_xlabel('$t$')

ax2.axhline(0, color='black', lw=0.8)
ax2.axvline(0, color='black', lw=0.8)
ax2.plot(sigma, omega, 'rx', markersize=7, mew=1.5)  # upper pole
ax2.plot(sigma, -omega, 'rx', markersize=7, mew=1.5) # lower pole
...
plt.tight_layout()
plt.savefig("unstable_oscillation.pdf")